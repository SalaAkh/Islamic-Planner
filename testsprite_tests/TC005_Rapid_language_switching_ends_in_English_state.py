...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to the site root at http://localhost:3000/ as the test step explicitly requests.
        await page.goto("http://localhost:3000/")
        
        # -> Click the 'RU' language switcher (element index 2956).
        ...
        # -> Click the 'Launch App' (Open App) button so the app opens (index 2875). After the click the page should navigate to /app.html (verify URL then).
        frame = context.pages[-1]
        # Click element
